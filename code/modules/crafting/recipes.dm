...
-- Category Robots (No subcrafting)
-- Category Weapon - Ammunition
                   - Weapons
-- Category Tribal - (See Forge.dm for subcategory)
-- Category Drugs
-- Category Miscallenous
-- Category Assembly
-- Category Medical
/* Category Clothing - Wasteland (See extended tailoring.dm for full list)*/
*/
/* Category Robots*/
